# Slider Piler (English Version) v2.15.2
<br />
...
### 1. Deploy a Cloud Compute Ubuntu 21.10 server from Vultr named "SPdotCom".
<br />

### 2. Open a PowerShell (as Admin) terminal & connect to your SPdotCom server's IP address via SSH:
`ssh root@enter.SPdotCom.IP.address`
<br />

**Enter the password provided by Vultr on the SPdotCom server page & follow all prompts until connected.**
<br />
<br />
...
**Restart the SPdotCom server then reconnect via SSH (repeat step 2).**
<br />
...
### 6. Clone the SliderPilerDotCom GitHub repository to the SPdotCom server:
`cd ~/`
<br />
...
`git clone https://github.com/Superklok/SliderPilerDotCom.git`
<br />
<br />

### 7. Install dependancies:
`cd SliderPilerDotCom/v2.x.x/`
<br />
...
`export PORT="ThePortSPdotComIsRunningOn"`
<br />
...
`cd superkloklabs/SliderPilerDotCom/v2.x.x/`
<br />

`pm2 serve build/ ThePortSPdotComIsRunningOn --name "SPdotCom" --spa`
<br />
<br />

### 9. Setup a start script to automatically start the app if the SPdotCom server is restarted:
`pm2 startup ubuntu`
<br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`proxy_pass http://localhost:ThePortSPdotComIsRunningOn;`
<br />
...
### 11. Update your DNS "A" records for "yourwebsite.com" & "www.yourwebsite.com" with the SPdotCom server IP address.
<br />
...
**Test the PM2 startup script by restarting the SPdotCom server:**
<br />

`sudo reboot`
<br />

**Then reconnect to the SPdotCom server via SSH (repeat step 2).**
<br />

**Check PM2 to make sure SPdotCom is still running:**
<br />
...
[docker]: https://hub.docker.com/r/superklok/sliderpilerdotcom/tags
